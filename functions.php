...
class detailsTheme {
	...
	function welcome(){
        ...
        <p><?php _e('Welcome to Details Theme! Please let me know if you have any questions or concerns, and enjoy your product.','details');?></p>
      </div>
      <div class="row">
        ...
        <div class="span6 zmb" style="text-align:center;">
          <a href="http://www.pagelines.com/forum/forum/68-store-products/" target="_blank" class="btn btn-info btn-mini"><i class="icon icon-ambulance"></i>  <?php _e('Support','details');?></a>
        </div>
      </div>
      <div style="margin-top:20px;color:#444;">
        ...
        <p style="font-size:12px;line-height:14px;"><?php _e('Details Theme is designed to work with core PageLines sections. To edit sections, click the pencil icon in the top left corner.','details');?></p>
      </div>
      <div style="margin-top:20px;color:#444;">
